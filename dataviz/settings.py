...
DATABASES = {
    'default': {
        ...
        'HOST': config('DJANGO_HOST'),   # Change if your database is hosted elsewhere
        'PORT': config('DJANGO_PORT'),        # Default MySQL port
    }
}
...
LOGIN_URL = 'login'  # Assuming your login URL is named 'login'